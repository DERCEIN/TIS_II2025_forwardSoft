...
class ConfiguracionOlimpiadaController
{
    ...
    public function updateConfiguracionGeneral()
    {
        try {
            ...
            // Validar campos requeridos solo si se están actualizando los campos generales
            // Si solo se están actualizando campos de evaluación (clasificacion_puntuacion_minima, tiempo_evaluacion), no validar
