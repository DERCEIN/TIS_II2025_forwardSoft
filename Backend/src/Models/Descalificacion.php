...
class Descalificacion
{
    ...
    public function create($data)
    {
        try {
            ...
            // Actualizar estado de la inscripción a descalificado
            $stmt = $this->db->prepare("
    ...
    /**
     * Obtener descalificaciones por inscripción
     */
    ...
    /**
     * Obtener todas las descalificaciones por área
     */
    ...
    public function revocar($id, $motivoRevocacion = null)
    {
        try {
            ...
            // Marcar descalificación como revocada
            $stmt = $this->db->prepare("
            ...
            // Obtener información de la descalificación
            $stmt = $this->db->prepare("
            ...
            if ($descalificacion) {
                // Verificar si hay otras descalificaciones activas para esta inscripción
                $stmt = $this->db->prepare("
                ...
                // Si no hay más descalificaciones activas, cambiar estado a evaluado
                if ($count == 0) {
                    $stmt = $this->db->prepare("
                        UPDATE inscripciones_areas 
                        SET estado = 'evaluado'
    ...
    /**
     * Verificar si un participante está descalificado
     */
    ...
    /**
     * Obtener estadísticas de descalificaciones por área
     */
