...
class ConfiguracionOlimpiada
{
    ...
    {
        // Primero obtener el ID de la configuración actual
        ...
        // Construir la consulta UPDATE dinámicamente solo con los campos presentes
        $setParts = [];
        $params = [];
        ...
        // Si no hay campos para actualizar, retornar el ID
        if (empty($setParts)) {
            return $id;
        }
