...
CREATE TABLE IF NOT EXISTS tutores_academicos (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (unidad_educativa_id) REFERENCES unidades_educativas(id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS olimpistas (
    ...
    FOREIGN KEY (unidad_educativa_id) REFERENCES unidades_educativas(id) ON DELETE RESTRICT,
